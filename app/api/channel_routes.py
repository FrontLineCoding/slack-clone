...
@channel_workspace_routes.route("/<int:workspaceId>/channels", methods=["GET"])
...
@channel_workspace_routes.route("/<int:workspaceId>/channels", methods=["POST"])
@login_required
...
@channel_workspace_routes.route("/<int:workspaceId>/channels/<int:channelId>", methods=["GET"])
@login_required
...
@channel_workspace_routes.route("/<int:workspaceId>/channels/<int:channelId>", methods=["PUT"])
@login_required
...
@channel_workspace_routes.route("/<int:workspaceId>/channels/<int:channelId>", methods=['DELETE'])
@login_required
